...
function shouldScroll(options) {
  ...
  return !step.disableScrolling && (!isFirstStep || scrollToFirstStep || lifecycle === LIFECYCLE.TOOLTIP) && (!step.isFixed || !hasPosition(target)) && // fixed steps don't need to scroll
...
var Joyride = class extends React9.Component {
  ...
  componentDidUpdate(previousProps, previousState) {
    ...
    if (status === STATUS.RUNNING && lifecycle === LIFECYCLE.INIT) {
